...
class Inc {
	...
	public static function computeVoxelsSDF() {
		var rts = path.renderTargets;
	 	...
	 	var passcount = Math.ceil(Math.log(res / Math.log(2.0)));
	 	...
	 	for (i in 0...passcount) {
			...
			kha.compute.Compute.setInt(voxel_cb2, armory.renderpath.RenderPathCreator.clipmapLevel);
	...
	public static function computeVoxelsLight() {
		...
		var lights = iron.Scene.active.lights;
	 	...
	 	for (i in 0...lights.length) {
			...
			kha.compute.Compute.setInt(voxel_cb5, armory.renderpath.RenderPathCreator.clipmapLevel);
