...
uniform layout(binding = 3, rgba8) writeonly image3D voxels;
#ifdef _ShadowMap
uniform layout(binding = 4) sampler2DShadow shadowMap;
uniform layout(binding = 5) sampler2DShadow shadowMapSpot;
uniform layout(binding = 6) samplerCubeShadow shadowMapPoint;
#endif
