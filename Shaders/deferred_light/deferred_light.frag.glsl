...
void main() {
	...
	float clipmapLevel = floor(max(log2(dist / voxelgiResolution.x), 0));
    float voxelSize = pow(2.0, clipmapLevel) * 2.0;
    vec3 eyeSnap = floor((viewerPos + eyeLook * voxelgiResolution.x) / voxelSize) * voxelSize;
...
//	#endif
	...
	fragColor.rgb += sampleLight(
		...
		#ifdef _VoxelAOvar
		#ifdef _VoxelShadow
		, voxels, voxpos, int(clipmapLevel)
		#endif
		#endif
		#ifdef _VoxelGI
		#ifdef _VoxelShadow
