#ifndef OIMO_COLLISION_NARROWPHASE_SPHERE_CAPSULE_DETECTOR_H
#define OIMO_COLLISION_NARROWPHASE_SPHERE_CAPSULE_DETECTOR_H
...
#endif // OIMO_COLLISION_NARROWPHASE_SPHERE_CAPSULE_DETECTOR_H
