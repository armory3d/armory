...
vec3 sampleLight(const vec3 p, const vec3 n, const vec3 v, const float dotNV, const vec3 lp, const vec3 lightCol,
	...
	#endif
	#ifdef _VoxelShadow
		, sampler3D voxels, sampler3D voxelsSDF, float clipmaps[10 * voxelgiClipmapCount], vec2 texCoord, vec2 velocity
	#endif
	...
	#ifdef _VoxelShadow
	direct *= (1.0 - traceShadow(p, n, voxels, voxelsSDF, l, clipmaps, texCoord, velocity).r) * voxelgiShad;
	#endif
