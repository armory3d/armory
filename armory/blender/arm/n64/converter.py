"""N64 Coordinate Converter - Applies coordinate conversion rules from macro JSON."""
...
def _load_coord_config():
    """Load coordinate config from n64_traits.json."""
...
def _apply_swizzle(vec, config):
    """Apply coordinate swizzle based on config rules."""
...
def _apply_quat_swizzle(quat, pos_cfg):
    """Apply coordinate swizzle to quaternion XYZ components (W unchanged)."""
