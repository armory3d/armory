...
""")
        ...
        if wrd.arm_modding_mode == "Game":
            ...
            f.write('project.addParameter("--macro armory.system.Modding.bindClasses(\'' + wrd.arm_modding_expose_classes + '\')");\n')
            ...
            f.write('project.addParameter("--macro armory.system.Modding.bindClasses(\'' + wrd.arm_project_package + '\')");\n')
            f.write('project.addParameter("--macro armory.system.Modding.generateOnlyClasses(\'(' + wrd.arm_project_package + '|Type)\')");\n')
