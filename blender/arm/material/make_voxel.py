...
def make_gi(context_id):
    ...
    vert.write('float voxelSize = pow(2.0, clipmapLevelGeom) * 2.0 * voxelgiStep;')
...
def make_ao(context_id):
    ...
    if arm.utils.get_gapi() == 'direct3d11':
        ...
        frag.write('vec3 uvw = (voxposition * 0.5 + clipmapOffset / voxelgiResolution.x) * voxelgiResolution.x;')
