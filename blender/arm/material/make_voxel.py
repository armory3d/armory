...
def make_gi(context_id):
    ...
    frag.write('if (abs(voxposition.z) < (clipmapLevel / clipmapCount) || abs(voxposition.x) < (clipmapLevel / clipmapCount) || abs(voxposition.y) < (clipmapLevel / clipmapCount)) return;')
