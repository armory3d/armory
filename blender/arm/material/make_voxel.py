...
def make_gi(context_id):
    ...
    vert.write('float clipmapLevelSize = voxelgiHalfExtents.x * pow(2.0, clipmapLevel + 1);')
    vert.write('float voxelSize = 0.125 * voxelgiHalfExtents.x / pow(2.0, clipmapLevel);')
    ...
    vert.write('clipmapOffsetGeom = eyeSnap - (0.5 * pow(2.0, clipmapLevel));')
