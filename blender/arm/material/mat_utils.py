...
def get_rpasses(material):
    ...
    if material.arm_decal:
        ...
        elif is_transluc(material) and not material.arm_discard and rpdat.rp_translucency_state != 'Off' and not material.arm_blending and not rpdat.arm_voxelgi_refraction:
