...
class SimpleFootIKNode(ArmLogicTreeNode):
    ...
    def arm_init(self, context):
        ...
        self.add_input('ArmFloatSocket', 'Scan Height', default_value = 1.0)
        self.add_input('ArmFloatSocket', 'Scan Depth', default_value = 1.0)
        self.add_input('ArmIntSocket', 'Collision Mask', default_value = 1)
        self.add_input('ArmFloatSocket', 'Height Offset', default_value = 0.0)
        self.add_input('ArmFloatSocket', 'Foot Offset', default_value = 0.0)
        self.add_input('ArmFloatSocket', 'Offset Threshold', default_value = 1.0)
