...
class GetDateTimeNode(ArmLogicTreeNode):
    ...
    property0: HaxeEnumProperty(
        'property0',
        items = [('now', 'Now', 'Get the full system date and time'),
                ('timestamp', 'Timestamp', 'Get all the individual separated date and time properties'),
                ('timeZoneOffSet', 'Timezone Offset', 'Get all the individual separated date and time properties'),
                ('weekday', 'Weekday', 'Get all the individual separated date and time properties'),
                ('day', 'Day', 'Get all the individual separated date and time properties'),
                ('month', 'Month', 'Get all the individual separated date and time properties'),
                ('year', 'Year', 'Get all the individual separated date and time properties'),
                ('hours', 'Hours', 'Get all the individual separated date and time properties'),
                ('minutes', 'Minutes', 'Get all the individual separated date and time properties'),
                ('seconds', 'Seconds', 'Get all the individual separated date and time properties'),
