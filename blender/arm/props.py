...
def init_properties():
    ...
    bpy.types.Object.arm_visible_shadow = BoolProperty(name="Lighting", description="Object contributes to the lighting", default=True, override={'LIBRARY_OVERRIDABLE'})
